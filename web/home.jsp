        ...
        <div id="popDiv" class="ontop">
            <div class="basic-modal-content" id="popup">
                ...
                <div class="basic-modal-content_MainformArea"  id="commenttr" style="display:none;"  >
                    ...
                    <font size="1" ><div style="margin-left: 180px; margin-top: 2px;color: red;" id="errauditcomment">&nbsp;</div></font>
                </div>

                <div class="basic-modal-content_MainformAreaTwo" >
                    <input type="button" value="OK" onclick="closeconfirm(document.getElementById('carton').value);"/>
                </div>
            </div>
        </div>
